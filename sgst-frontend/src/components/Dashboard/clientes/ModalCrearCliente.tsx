...
import type { DatosCrearCliente } from "../../../services/interfaces";
import { crearClienteTaller } from "../../../services/api";

type Props = {
    cerrarModal: () => void;
    formDatos: DatosCrearCliente
    setFormDatos: React.Dispatch<React.SetStateAction<DatosCrearCliente>>;
    mostrarToast: (mensaje: string, tipo: "success" | "error") => void;
    cliente_creado: () => void
}

export const ModalCrearCliente = ({ cerrarModal, formDatos, setFormDatos, mostrarToast, cliente_creado }: Props) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (formDatos.nombre_cliente.trim() === "") nuevosErrores.nombre_cliente = "El nombre es obligatorio";
        if (formDatos.apellidos_cliente.trim() === "") nuevosErrores.apellidos_cliente = "Los apellidos son obligatorios";
        if (formDatos.correo_cliente.trim() === "") nuevosErrores.correo_cliente = "El correo es obligatorio";
        if (formDatos.telefono_cliente.trim() === "") nuevosErrores.telefono_cliente = "El teléfono es obligatorio";
        ...
        try {
            const respuesta = await crearClienteTaller(formDatos);
        ...
        >
            ...
            >
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        <h1 className="text-slate-900 text-3xl font-bold">Nuevo cliente</h1>
                    </div>
                        ...
                        <div>
                            ...
                            <div className='flex gap-6'>
                                <input
                                    ...
                                    value={formDatos.nombre_cliente}
                                ...
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    value={formDatos.apellidos_cliente}
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    id="correo_cliente"
                                    name="correo_cliente"
                                    value={formDatos.correo_cliente}
                                    onChange={handleInputChange}
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    onChange={handleInputChange}
                                    value={formDatos.telefono_cliente}
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                <input
                                    ...
                                    value={formDatos.direccion_cliente}
                                    onChange={handleInputChange}
